...
namespace SpotifyAPI.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        public async Task<ActionResult<GeneroModel>> GetGenero(int id)
        {
            ...
            if (Genero == null)
                return NotFound($"Genero com ID {id} não encontrada.");
        ...
        {
            if (Genero == null)
                return BadRequest("Dados inválidos para criar uma nova Gênero.");
        ...
        public async Task<ActionResult<int>> DeleteGenero(int id)
        {
            ...
            if (Genero == null)
            {
                return NotFound($"Genero com o ID {id} não encontrada.");
            }

            await _GeneroService.DeleteGeneroAsync(id);

            return Ok("Gênero deleta com sucesso");
        }
